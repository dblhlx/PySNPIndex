...
def statistics(row):
    ...
    # Create arraies of SNP indice and Δ(SNP index) of a SNP
...
if os.path.isfile(os.path.join(path, 'COMPLETE.txt')) == False:
    ...
    # Create new columns for Fisher's exact test results, SNP index, Δ(SNP index) confidence intervals, and G-statistic thresholds
